 ...
 */
@Entity
@Table(name = "backup_borrow_record", schema = "ooad", catalog = "")
public class BackupBorrowRecord {
    private int id;
    private int userId;
    ...
    public boolean equals(Object o) {
        ...
        BackupBorrowRecord that = (BackupBorrowRecord) o;
